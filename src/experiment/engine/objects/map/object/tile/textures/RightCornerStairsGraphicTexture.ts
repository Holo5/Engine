...
export class RightCornerStairsGraphicTexture extends FloorGraphicTexture {
    public drawParts(): void {
        this.addChild(
            ...
            this.drawPart(this._material, this._thickness, 8, 8, 52, new Matrix(0, 1, -1, 0.5), 0.9),
        );
        ...
        this.addChild(
            ...
            this.drawPart(this._material, this._thickness, 8, 16, 40, new Matrix(0, 1, -1, 0.5), 0.9),
        );
        ...
        this.addChild(
            ...
            this.drawPart(this._material, this._thickness, 8, 24, 28, new Matrix(0, 1, -1, 0.5), 0.9),
        );
        ...
        this.addChild(
            ...
            this.drawPart(this._material, this._thickness, 8, 32, 16, new Matrix(0, 1, -1, 0.5), 0.9),
        );
    }
}
