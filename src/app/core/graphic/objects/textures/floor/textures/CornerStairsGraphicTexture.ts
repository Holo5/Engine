...
export class CornerStairsGraphicTexture extends FloorGraphicTexture {
    public drawParts(): void {
        ...
        this.addChild(
            ...
            this.drawPart(this._material, this._thickness, 24, 24, 28, new PIXI.Matrix(0, 1, -1, 0.5), 0.8),
        );
        ...
        this.addChild(
            ...
            this.drawPart(this._material, this._thickness, 16, 16, 16, new PIXI.Matrix(0, 1, -1, 0.5), 0.8),
        );
        ...
        this.addChild(
            ...
            this.drawPart(this._material, this._thickness, 8, 8, 4, new PIXI.Matrix(0, 1, -1, 0.5), 0.8),
        );
    }
}
